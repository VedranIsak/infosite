import styles from './CirclesContainer.module.css';
import './CirclesContainer.css';

export default function CirclesContainer({firstHrefs, secondHrefs, firstAnchorTexts, secondAnchorTexts}) {
    ...
    return(
            <>
                <div id="circle-container" className={styles.skillsContainer}>
                    <h2 id="circles-header">Dive deeper into the technologies I use</h2>
